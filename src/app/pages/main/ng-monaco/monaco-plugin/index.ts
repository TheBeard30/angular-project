...
import {IParseResult} from "../sql/parser";
import {ICompletionItem, ICursorInfo, ITableInfo, reader} from "../sql/sql-parser";
    ...
    provideCompletionItems: async () => {
      ...
      switch (cursorInfo.type) {
        ...
        case 'tableFieldAfterGroup':
          ...
          console.log('cursorRootStatementFieldsAfter>>>',cursorRootStatementFieldsAfter);
          return returnCompletionItemsByVersion(
...
const worker: Worker = new Worker(new URL('./parser.worker', import.meta.url));
